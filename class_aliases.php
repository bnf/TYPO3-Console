...
namespace compat {
    ...
    if (!class_exists(\TYPO3\CMS\Install\Updates\AbstractUpdate::class)) {
        class_alias(AbstractUpdate::class, \TYPO3\CMS\Install\Updates\AbstractUpdate::class, true);
    }


    if (!interface_exists(\TYPO3\CMS\SaltedPasswords\Salt\SaltInterface::class)) {
        class_alias(\TYPO3\CMS\Core\Crypto\PasswordHashing\PasswordHashInterface::class, \TYPO3\CMS\SaltedPasswords\Salt\SaltInterface::class, true);
    }
}
